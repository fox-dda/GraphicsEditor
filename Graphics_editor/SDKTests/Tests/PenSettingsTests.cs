...
namespace GraphicsEditor.Tests
{
    ...
    public class PenSettingsTest
    {
        ...
        public void DashPattertSetTest(float dashValue, float spaceValue)
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { penSettings.DashPattern = new[] { dashValue, spaceValue }; });
        }
        ...
        public void WidthSetTest(float width)
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { penSettings.Width = width; });
        }
        ...
        public void ColorSetTest()
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { penSettings.Color = Color.Green; });
        }
