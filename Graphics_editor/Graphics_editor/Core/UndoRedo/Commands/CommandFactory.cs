...
namespace GraphicsEditor.Core.UndoRedo.Commands
{
    ...
    public class CommandFactory : ICommandFactory
    {
        ...
        public RemoveRangeDraftsCommand CreateRemoveRangeDraftsCommand(List<IDrawable> storage,
            List<IDrawable> removebleList)
        {
        ...
        public EditCanvasColorCommand CreateEditCanvasColorCommand(IPaintingParameters paintengParameters,
            Color newColor)
        {
