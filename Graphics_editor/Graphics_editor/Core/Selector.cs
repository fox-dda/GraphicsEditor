    ...
    public class Selector : ISelector
    {
            ...
            List<IDrawable> draftList)
        {
            ...
            for (var i = draftList.Count - 1; i > -1; i--)
            {
                ...
                if (sy > fsy && ey < fey && sx > fsx && ex < fex) findList.Add(draftList[i]);
            }
            ...
            List<IDrawable> highlighList)
        {
            ...
            foreach (var draft in highlighList)
                ...
                {
                    foreach (var point in multipoint.DotList.Where(point => IsInRect(mousePoint, point, 6)))
        ...
        {
            return desiredPoint.X > rectPoint.X &&
