...
namespace GraphicsEditor.Tests
{
    ...
    {
        private HighlightRect HighlightRect => new HighlightRect();
        ...
        public void StartPointSetTest()
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { HighlightRect.StartPoint = point; });
        }
        ...
        public void EndPointSetTest()
        {
            ...
            var point = new Point(0, 0);
            // Act/Assert
            Assert.DoesNotThrow(() => { HighlightRect.EndPoint = point; });
        }
        ...
        public void PenSetTest()
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { HighlightRect.Pen = pen; });
        }
