...
namespace GraphicsEditor.Tests
{
    ...
    public class RemoveDraftCommandTest
    {
        ...
        public void DoTest_WithNullList()
        {
            ...
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { removeDraftCommand.Do(); });
        }
        ...
        public void UndoTest_WithNullList()
        {
            ...
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { removeDraftCommand.Undo(); });
        }
        ...
        public void DoTest_WithNullDraft()
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { removeDraftCommand.Do(); });
        }
        ...
        public void UndoTest_WithNullDraft()
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { removeDraftCommand.Undo(); });
        }
    }
}