...
namespace GraphicsEditor.Tests
{
    ...
    public class AddDraftCommandTest
    {
        ...
        public void DoTest_WithNullList()
        {
            ...
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { addDraftCommand.Do(); });
        }
        ...
        public void UndoTest_WithNullList()
        {
            ...
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { addDraftCommand.Undo(); });
        }
        ...
        public void DoTest_WithNullDraft()
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { addDraftCommand.Do(); });
        }
        ...
        public void UndoTest_WithNullDraft()
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { addDraftCommand.Undo(); });
        }
    }
}