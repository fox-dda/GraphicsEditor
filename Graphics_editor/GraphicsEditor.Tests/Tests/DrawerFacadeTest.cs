...
namespace GraphicsEditor.Tests
{
    ...
    public class DrawerFacadeTest
    {
        ...
        public void DrawShape_WithNullGraphicsProperty()
        {
            ...
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { DrawerFacade.DrawShape(draft, null); });
        }
        ...
        public void DrawShape_WithNullDraft()
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { DrawerFacade.DrawShape(draft, null); });
        }
        ...
        public void DrawHighlight_WithNullGraphics()
        {
            ...
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { DrawerFacade.DrawHighlight(draft, null); });
        }
        ...
        public void DrawHighlight_WithNullDraft()
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { DrawerFacade.DrawHighlight(draft, null); });
        }
    }
}