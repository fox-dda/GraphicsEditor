...
namespace GraphicsEditor.Tests
{
    ...
    public class DraftPainterTest
    {
        ...
        public void DynamicDrawing_DrawWithNullGraphicsProperty()
        {
            ...
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { DraftPainter.DynamicDrawing(mousePoint); });
        }
        ...
        {
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { DraftPainter.RefreshCanvas(); });
        }
        ...
        public void ClearCanvas_WithNullGraphicsProperty()
        {
            ...
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { draftPainter.ClearCanvas(); });
        ...
        {
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { DraftPainter.AddToStorage(); });
