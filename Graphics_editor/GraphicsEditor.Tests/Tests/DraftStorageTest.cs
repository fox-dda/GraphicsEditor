...
namespace GraphicsEditor.Tests
{
    ...
    public class DraftStorageTest
    {
        ...
        {
            // Act/Assert
            Assert.DoesNotThrow(() => { DraftStorage.DraftList = new List<IDrawable>(); });
        }
        ...
        {
            // Act/Assert
            Assert.DoesNotThrow(() => { DraftStorage.DraftList = null; });
        }
        ...
        {
            // Act/Assert
            Assert.DoesNotThrow(() => { DraftStorage.HighlightDraftsList = new List<IDrawable>(); });
        }
