...
namespace GraphicsEditor.Tests
{
    ...
    public class DrawManagerTest
    {
        ...
        {
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { DrawManager.Deserialize(null); });
        ...
        public void KeyProcessTest_PressAny(char buttonCode)
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { DrawManager.KeyProcess(arg, clipBoardMock.Object); });
        }
        ...
        public void MouseProcessTest_WithMultipointStrategy_NotException(MouseAction mouseAction)
        {
            ...
            // Act/Assert
            Assert.DoesNotThrow(() => { manager.MouseProcess(mouseArgs, mouseAction); });
        }
        ...
        public void MouseProcessTest_WithMultipointStrategy_Exception(MouseAction mouseAction)
        {
            ...
            // Act/Assert
            Assert.Throws(typeof(NullReferenceException), () => { manager.MouseProcess(mouseArgs, mouseAction); });
        }
