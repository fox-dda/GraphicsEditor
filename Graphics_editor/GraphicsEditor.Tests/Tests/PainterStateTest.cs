...
namespace GraphicsEditor.Tests
{
    ...
    public class PainterStateTest
    {
        ...
        {
            // Act/Assert
            Assert.DoesNotThrow(() => { PainterState.InProcessPoints = new List<Point>(); });
        }
        ...
        {
            // Act/Assert
            Assert.DoesNotThrow(() => { PainterState.InProcessPoints = null; });
        }
        ...
        {
            // Act/Assert
            Assert.DoesNotThrow(() => { PainterState.UndrawableDraft = null; });
        }
        ...
        {
            // Act/Assert
            Assert.DoesNotThrow(() => { PainterState.DragDropDotingDot = new Point(1, 1); });
        }
